...
export default function HomePage() {
  ...
  return (
    <main className="flex flex-col items-center min-h-screen bg-gradient-to-br from-primary/5 via-background to-background text-foreground overflow-x-hidden">
      {/* Hero Section */}
      <section className="w-full py-20 md:py-32 flex flex-col items-center justify-center text-center px-4">
        <div className="max-w-3xl mx-auto animate-in fade-in slide-in-from-bottom-12 duration-700">
          <AppLogo className="justify-center mb-8" iconClassName="h-20 w-20" textClassName="text-6xl" hideTextOnMobile={false} />
      ...
      <section className="w-full py-16 md:py-24 bg-card px-4">
        <div className="container mx-auto max-w-5xl grid md:grid-cols-2 gap-12 items-center">
          <div className="animate-in fade-in slide-in-from-left-16 duration-700 delay-200">
            <h2 className="text-3xl md:text-4xl font-headline font-bold text-primary mb-6">Stop Wrestling with Invoices.</h2>
      ...
      <section className="w-full py-16 md:py-24 px-4">
        <div className="container mx-auto max-w-6xl">
          <div className="text-center mb-12 md:mb-16 animate-in fade-in slide-in-from-bottom-12 duration-700">
            <h2 className="text-3xl md:text-4xl font-headline font-bold text-primary mb-4">Everything You Need, Nothing You Don't.</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {features.map((feature, index) => (
              <div key={feature.title} className={`animate-in fade-in slide-in-from-bottom-${12 + index * 2} duration-700 delay-${200 + index * 150}`}>
                <Card className="h-full flex flex-col hover:shadow-2xl transition-shadow duration-300 bg-card">
                  <CardHeader className="items-center text-center">
                    <div className="p-4 bg-accent/10 rounded-full mb-4 inline-block">
                      {feature.icon}
                    </div>
                    <CardTitle className="font-headline text-2xl mb-2 text-primary">{feature.title}</CardTitle>
                  </CardHeader>
      ...
      {/* Final CTA Section */}
      <section className="w-full py-16 md:py-24 bg-primary/10 px-4">
        <div className="container mx-auto max-w-3xl text-center animate-in fade-in slide-in-from-bottom-12 duration-700 delay-300">
          ...
          <h2 className="text-3xl md:text-4xl font-headline font-bold text-primary mb-6">Ready to Transform Your Invoicing?</h2>
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            ...
            <Button asChild variant="outline" size="lg" className="text-lg px-8 py-6 border-primary/50 hover:bg-primary/5">
      ...
      <footer className="w-full py-8 border-t bg-card">
        <div className="container mx-auto text-center text-muted-foreground text-sm">
          <AppLogo className="justify-center mb-4" iconClassName="h-8 w-8" textClassName="text-xl" hideTextOnMobile={false}/>
